...
func (s *Object) CreateObject(ctx context.Context, request shared.ObjectInput) (*operations.CreateObjectResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "create_object"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/object")
	if err != nil {
...
func (s *Object) GetObjects(ctx context.Context) (*operations.GetObjectsResponse, error) {
	hookCtx := hooks.HookContext{OperationID: "get_objects"}

	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := url.JoinPath(baseURL, "/objects")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
